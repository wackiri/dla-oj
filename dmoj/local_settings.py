...
DATABASES = {
    'default': {
        ...
        'NAME': 'wackiri$dmoj',
        'USER': 'wackiri',
        'PASSWORD': 'dmoj@123Abc',
        'HOST': 'wackiri.mysql.pythonanywhere-services.com',
        'OPTIONS': {
            'charset': 'utf8mb4',
...
ADMINS = (
    ('Wackiri', 'wackiri@gmail.com'),
)

# The sender for the aforementioned emails.
SERVER_EMAIL = 'DLA OJ: DLA Online Judge <wackiri@gmail.com>'
...
SITE_NAME = 'DLA OJ'
SITE_LONG_NAME = 'DLA OJ: DLA Online Judge'
SITE_ADMIN_EMAIL = 'wackiri@gmail.com'
